    ...
    DateRangePicker.prototype = {
        ...
        renderCalendar: function(side) {
            ...
            if ((!minDate || minDate.isBefore(calendar.firstDay)) && (!this.linkedCalendars || side == 'left')) {
                html += '<th class="prev available"><i class="ion-ios-arrow-' + arrow.left + ' fa fa-angle-' + arrow.left + '"></i></th>';
            } else {
                html += '<th></th>';
            }
            ...
            if ((!maxDate || maxDate.isAfter(calendar.lastDay)) && (!this.linkedCalendars || side == 'right' || this.singleDatePicker)) {
                html += '<th class="next available"><i style = "padding-left:22px " class="ion-ios-arrow-' + arrow.right + ' fa fa-angle-' + arrow.right + '"></i></th>';
            } else {
                html += '<th></th>';
            }
