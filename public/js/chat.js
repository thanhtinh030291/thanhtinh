...
socket.on('chatListRes', function (data) {
  if (data.userDisconnected) {
    ...
    data.chatList.findIndex(function (el) {
      console.log(el.msgCount);
      el.msgCount = 0;
    });
    app.chatLists = data.chatList; //console.log(app.chatLists)
  }
...
module.exports = __webpack_require__(/*! /usr/local/var/www/claimassistants/resources/assets/js/chat.js */"./resources/assets/js/chat.js");
