...
window.Echo = new laravel_echo__WEBPACK_IMPORTED_MODULE_0__["default"]({
  ...
  host: "node.".concat(window.location.hostname)
});
window.Echo.channel('user.' + USER_ID).listen('Notify', function (e) {
  console.log(e);
  pusher(e); //$('#content').append(`<div class="well">${e.message}</div>`);
});
