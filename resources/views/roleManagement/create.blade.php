...
<div class="row">
    <div class="col-md-12">
        <div class="card">
            <div class="card-body">
                {{ Form::open(array('url' => 'admin/role', 'method' => 'post' ,'class'=>'form-horizontal')) }}
                    ...
                    {{ Form::select('_permissions', $all_permissions_in_database, old('_permissions'), ['class' => ' select2 form-control', 'multiple' => 'multiple', 'name' => '_permissions[]']) }}<br>
