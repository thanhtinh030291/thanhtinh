            ...
            <div class="card">
                <div class="card-body">
                        <div class="form-group col-md-12">
                            ...
                            {!! Form::text('name', $roomAndBoard->name, ['class' => 'form-control']) !!}
                        </div>
                    ...
                    <tr id="clone_item" style="display: none;">
                        ...
                        <td style="width:310px">
                            <div style="width:310px">
                                {!! Form::text('_incur_date_default', null ,  ['class' => 'datetimepicker form-control' ,'placeholder' => 'Not Reject' , 'readonly' , 'disabled']) !!}
                            </div>
                        </td>
                        <td>
