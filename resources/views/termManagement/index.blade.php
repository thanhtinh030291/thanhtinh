...
@include('layouts.admin.breadcrumb_index', [
    'title'       => __('message.term'),
    'page_name'   => __('message.term'),
])
<div class="row">
    <div class="col-md-12">
        <a class="btn btn-primary pull-right" href="{{ url('admin/term/create') }}">
            {{ __('message.create')}}
        </a>
    </div>
</div>
...
<div class="row">
    <div class="col-md-12">
        <form action="{{ url('admin/term') }}" method="GET" class="form-horizontal" >
            <div class="card">
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            {{ Form::text('description', $search_params['description'], ['class' => 'form-control']) }}
                        </div>
                        {{-- <div class="col-md-6">
            ...
            @include('layouts.admin.partials.condition_advance', ['limit_list' => $limit_list, 'limit' => $limit, 'list' => $data, 'urlPost' => route('term.index'), 'search_params' => $search_params])
        </form>
    </div>
</div>
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td class='text-center'>
                                    <!-- control -->
                                    <a class="btn btn-primary" href='{{ url("admin/term/$value->id") }}'>{{ __('message.view') }}</a>
                                    <a class="btn btn-success" href='{{ url("admin/term/$value->id/edit") }}'>{{ __('message.edit') }}</a>
                                    <button type="button" class="btn btn-danger btn-delete" data-url="{{ route('term.destroy', $value->id) }}"
...
@include('layouts.admin.partials.delete_model', [
    'title'           => __('message.term_warning'),
    'confirm_message' => __('message.term_confirm'),
])
