<div id="declinedClaimModal" class="modal" role="dialog">
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <h6>Health Etalk sẽ tự động cập nhật trạng thái Declined</h6>
                {{ Form::open(array('url' => '/admin/declinedStatusEtalk', 'method' => 'POST')) }}
                    {{-- HBS --}}
