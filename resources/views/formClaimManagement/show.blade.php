        ...
        <div class="card">
            <div class="card-body">
                ...
                <div class="row">
                    <div class="col-md-9">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-4">
                                {{ Form::text('type', Config::get('constants.typeTrans.'.$transport->type), ['id' => 'typeTrans','class' => 'form-control', 'required', 'disabled', 'placeholder' => __('message.please_select')]) }}
                            </div>
                        </div>
                        <div class=" row">
                            <div class="col-sm-2 col-form-label d-flex justify-content-end">
                            ...
                            <div class="col-sm-4">
                                {{ Form::text('option', $valueOption[$transport->option], [ 'id'=>'optionTrans','class' => 'form-control', 'required', 'placeholder' => __('message.please_select')]) }}
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-sm-2 col-form-label d-flex justify-content-end">
                            ...
                            <div class="col-sm-4">
                                {{ Form::text('depart_place', Config::get('constants.stationList.'.$transport->depart_place), [ 'class' => 'form-control', 'required', 'placeholder' => __('message.please_select')]) }}
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-sm-2 col-form-label d-flex justify-content-end">
                            ...
                            <div class="col-sm-4">
                                {{ Form::text('arrival_place', Config::get('constants.stationList.'.$transport->arrival_place), [ 'class' => 'form-control', 'required', 'placeholder' => __('message.please_select')]) }}
                            </div>
                        </div>
                        @include('layouts.admin.multi_lang', [
                            'lang_list'   => $langs,
                        ...
                        <div class="row" style="margin-top: 10px;">
                            ...
                            <div class="col-sm-3">
                                {{ Form::text('status', Config::get('constants.statusList.'.$transport->status), ['class' => 'form-control', 'required', 'placeholder' => __('message.please_select')]) }}<br/>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-sm-9 offset-sm-2">
                                <table id="information" class="table table-bordered table-hover display dataTable">
                                    <thead>
                                        <tr>
                                            <th>{{ __('message.created_user_id') }}</th>
                                            <th>{{ __('message.updated_user_id') }}</th>
                                    ...
                                    <tbody>
                                        <tr>
                                            <td>{{ $transport->userCreated->name }}</td>
                                            <td>{{ $transport->userUpdated->name }}</td>
                ...
                <div class="d-flex justify-content-center">
                    <a class="btn btn-secondary btnt" href="{{url('admin/transport')}}">{{ __('message.back')}}</a>
                </div>
                <!-- End file image -->
            </div>
        </div>
...
<script>
    $(document).on('ready', function(){
        $(":input:not(.kv-file-zoom)").attr('disabled', 'disabled');
